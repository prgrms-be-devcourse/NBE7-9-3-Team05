...
interface LocalAuthApi {
    ...
    fun signup(@RequestBody request: @Valid SignupRequest): ResponseData<AuthResponse>
    ...
    @PostMapping("/login")
    fun login(@RequestBody request: @Valid LoginRequest): ResponseData<AuthResponse>
